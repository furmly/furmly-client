...
import { runDynamoProcessor, getMoreForGrid, filterGrid, getSingleItem, showMessage } from "./actions";
...
export default (Layout, List, ItemView, Header, ProgressBar, CommandsView, NavigationActions, Container) => {
	...
	const mapDispatchToProps = dispatch => {
		return {
			...
			getSingleItem: (id, args, key) => dispatch(getSingleItem(id, args, key)),
