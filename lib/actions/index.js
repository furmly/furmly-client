...
function defaultError(dispatch, customType, meta) {
  return {
    ...
    meta: (action, state, res) => {
      if (customType && res.status !== 401) dispatch(displayMessage(res.statusText||"Sorry , an error occurred while processing your request"));
      ...
      [CALL_API]: preDispatch(
        {
          ...
          types: [
            { type: ACTIONS.DYNAMO_PROCESS_RUNNING, meta: {id:details.id,form:details.form} },
            {
